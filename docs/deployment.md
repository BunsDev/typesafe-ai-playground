...
The sharing image is `public/og.png`. Next.js metadata declares it for Open Graph
and Twitter, with the production origin as `metadataBase`. Each workspace has its
own browser title.
